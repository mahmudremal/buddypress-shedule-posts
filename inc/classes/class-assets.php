...
class Assets {
	...
	public function register_scripts() {
		...
		wp_register_script( 'fwp-bsp-frontend', FUTUREWORDPRESS_PROJECT_BUILD_JS_URI . '/frontend.js', [ 'jquery', 'fullcalendar' ], $this->filemtime( FUTUREWORDPRESS_PROJECT_BUILD_JS_DIR_PATH . '/frontend.js' ), true );
